...
export function getPrerenderRoutes({ includeProducts = false } = {}) {
  ...
  // The nine keyword landing pages, read from the same module the routes and the pages use,
  // so a tenth is prerendered without touching this file.
  for (const p of landingPagePaths) routes.push(p);
