// Company information sourced from KEAA International / Runi Industries
...
export const company = {
  ...
  description:
    'KEAA International Pvt. Ltd. is an Indo-Dutch company established in 2003, manufacturing and exporting scaffolding systems, formwork accessories, safety products, livestock housing solutions and garden hardware from 25,000 sq. m of in-house manufacturing facilities in Ludhiana, India.',
  ...
  landline: ['+91-161-2510944', '+91-161-2510946'],
  fax: '+91-161-2510945',
  ...
  stats: [
    ...
    { label: 'Skilled Employees', value: '150+' },
  ],
  ...
  machinery: [
    ...
    { name: 'Hot Dip Galvanizing Plant', desc: 'In-house 4 m and 1.7 m zinc baths per DIN EN 1461.' },
    { name: 'Automatic Powder Coating Plant', desc: 'Uniform, durable powder-coated finishes for select product lines.' },
  ],
  ...
  processSteps: [
    ...
    { step: '03', title: 'Forging & Shaping', desc: 'CNC press brake forming and forging for strength and durability.' },
