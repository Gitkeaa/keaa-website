/*
 * Full list of countries with ISO code, international dialling (STD/ISD) code
 * (no flag emoji: Chrome on Windows has no flag glyphs and renders them as bare
 * country letters). Powers the searchable CountrySelect + auto dial-code PhoneField
 * used across every form. Keep entries sorted by name.
 */
...
export const defaultCountry =
  countriesData.find((c) => c.iso === 'IN') || countriesData[0];
